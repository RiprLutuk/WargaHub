...
.admin-sidebar.collapsed .sidebar-top { flex-direction: column; align-items: center; gap: 0.75rem; }
.admin-brand { width: fit-content; text-decoration: none; }
.sidebar-toggle-btn { display: grid; width: 2.2rem; height: 2.2rem; place-items: center; border-radius: 0.55rem; border: 1px solid rgba(255, 255, 255, 0.2); background: rgba(255, 255, 255, 0.12); color: #ffffff; cursor: pointer; transition: background 0.15s; flex: none; }
.sidebar-toggle-btn:hover { background: rgba(255, 255, 255, 0.25); color: white; }
...
.back-portal { display: flex; min-height: 2.5rem; align-items: center; gap: 0.5rem; margin-top: auto; padding: 0.5rem 0.6rem; color: #d9eee8 !important; font-size: 0.8rem; font-weight: 600; text-decoration: none; border-radius: var(--radius-md); }
...
.admin-topbar strong { font-family: var(--font-display); font-weight: 700; font-size: 1.05rem; }
.admin-topbar span { color: var(--ink-650); font-size: 0.78rem; }
