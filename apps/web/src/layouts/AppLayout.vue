...
.portal-sidebar.collapsed .sidebar-top { flex-direction: column; align-items: center; gap: 0.75rem; }
.sidebar-brand { text-decoration: none; }
.sidebar-toggle-btn { display: grid; width: 2.2rem; height: 2.2rem; place-items: center; border-radius: 0.55rem; border: 1px solid var(--line-strong, #cbd5e1); background: var(--cream-50); color: var(--ink-700); cursor: pointer; transition: background 0.15s; flex: none; }
.sidebar-toggle-btn:hover { background: var(--teal-50); border-color: var(--teal-600); color: var(--teal-800); }
...
.admin-switch { display: flex; align-items: center; gap: 0.5rem; margin-top: auto; padding: 0.6rem 0.75rem; border-radius: var(--radius-md); background: var(--teal-50); border: 1px solid var(--teal-100); color: var(--teal-800); font-size: 0.82rem; font-weight: 800; text-decoration: none; }
...
.portal-topbar small { font-size: 0.76rem; color: var(--ink-650); }
